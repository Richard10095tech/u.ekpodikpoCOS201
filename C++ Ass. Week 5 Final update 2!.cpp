...
int main(){
  ...
  int course;
	cout<<"Enter Course (1-5) Each has Registration Fee beside them"<<endl
 ...
 if (days > 5 && (regfee > 12000)){
    ...
    cout<<"Random Bonus for whoever is lucky enough!!"<<endl;
     ...
     cout<<"\n";
     cout<<"Do you want to register another student? (Enter 1 for YES or 0 for NO) \n";
     cin>>repeat; 
     
     switch(repeat){
     	case 1:
     		cout<<"Starting new registration \n";
     		break;
     	case 0:	
     	    cout<<"Good Bye and Enjoy your day!! \n";
     	    break;
     	default:
		    cout<<"Invalid Input!";
			return 0; 
